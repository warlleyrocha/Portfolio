<script>
    ...
    let steps = [
        {name: 'Núcleo Corporation', icon: 'fa-solid fa-record-vinyl'},
        {name: 'Maisa Alves - Terapias Holísticas', icon: 'fa-solid fa-heart-circle-plus'},
...
<main class="flex flex-col flex-1 p-4">
    <section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
        <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Warlley</span> Rocha <br/>Front-End
                <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400">favorite tech</span> includes JavaScript (JQuery), TailwindCSS or Bootstrap!
            </p>
    ...
    <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>Smoljames Store is a merchandising store created with<strong class="text-violet-400">Next.js Commerce.js Stripe & Node.js + Express.js!</strong>Commerce.js is a product CMS and Stripe is used for all transaction handling. </p>
            </Step>
            <Step step={steps[1]}>
                <p>Smoljames Store is a merchandising store created with<strong class="text-violet-400">Next.js Commerce.js Stripe & Node.js + Express.js!</strong>Commerce.js is a product CMS and Stripe is used for all transaction handling. </p>
            </Step>
