...
<a href={step.href} target="_blank" class="p-4 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-solid border-[#00A40D] text-center group cursor-pointer hover:border-green-400 duration-200">
